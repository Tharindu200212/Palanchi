    ...
    <?php include 'header.php'; ?>
        ...
        <div class="slider-show-container">
            <video autoplay muted loop>
                <source src="images/4480575-hd_1920_1080_30fps.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            
            <!-- Overlay Content for Text and Button -->
            <div class="overlay-content">
                <h2>Connecting you to quality craftsmanship</h2>
                <p>Built by Palanchi</p>
                <a href="order.php" class="shop-now-btn">HIRE NOW</a>
            </div>
        </div>
    </div>
    </div>
